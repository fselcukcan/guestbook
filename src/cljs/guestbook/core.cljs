...
; to not reset our app state's db unnecessarily everytime we call rf/dispatch [:app/initialize]) we separate our "initialization logic" from our "rendering logic"
